...
% other parameters can be plotted by modifying this code.
...
% 
%   - Total body mass (M)
%   - Infinite frequency added mass (Ainf)
...
elevationData(:,2) = M(:,2);        % Ramped wave elevation
...
% user can navigate to the simulation output directory and double-click the
% workspace file to add the variables.
...
figure(1,"Name","Wave elevation profile");
...
figure(2,"Name","Force comparisons");
subplot(2,1,1);
...
figure(3,"Name","Dynamic response comparisons");
subplot(1,3,1);
plot(wecTime,wecZ,'-b','DisplayName','WEC-Sim');
hold on
...
figure(4,"Name","Difference measurements");
subplot(3,1,1);
