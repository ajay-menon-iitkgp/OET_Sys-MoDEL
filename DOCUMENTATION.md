...
1. Perform a diffraction analysis of the RM3 float (`float.stl` mesh provided). `rm3.out` is the WAMIT output file for RM3, where 'body' is the float and 'body2' is the spar.
